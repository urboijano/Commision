...
urlpatterns = [
    ...
    path('api/stores/active/', views.active_stores, name='active-stores'),
    ...
    path('api/orders/clear-completed/', views.clear_completed_orders, name='clear-completed-orders'),
    path('api/orders/<uuid:order_id>/cancel/', views.cancel_order, name='cancel-order'),
    path('api/orders/<uuid:order_id>/', views.order_detail, name='order-detail'),
    path('api/orders/group/<uuid:group_id>/', views.order_group, name='order-group'),
    ...
    path('api/kaon-admin/menu/<int:item_id>/delete/', views.admin_delete_menu_item, name='admin-menu-delete'),
    path('api/kaon-admin/stores/', views.admin_stores, name='admin-stores-list'),
    path('api/kaon-admin/stores/<int:store_id>/approve/', views.admin_approve_store, name='admin-store-approve'),
    path('api/kaon-admin/stores/<int:store_id>/reject/', views.admin_reject_store, name='admin-store-reject'),
    ...
    path('store/add/', views.add_store_page, name='add-store-page'),
    ...
    path('order/group/<uuid:group_id>/', views.order_group_page, name='order-group-page'),
